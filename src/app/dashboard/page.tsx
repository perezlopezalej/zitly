  ...
  return (
    <div>
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          <p className="text-xs font-medium text-brand-green uppercase tracking-wide">Gestionar</p>
        ...
        <Link
          ...
          className="block bg-white rounded-xl border border-gray-200 p-5 hover:border-brand-green hover:shadow-sm transition-all"
        >
          <p className="text-xs font-medium text-brand-green uppercase tracking-wide">Ver</p>
