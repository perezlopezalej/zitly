...
export function BookingEmail({ clientName, businessName, serviceName, date, time, employeeName }: BookingEmailProps) {
  return (
    <html lang="es">
      <head>
        <meta charSet="utf-8" />
                    ...
                    <tr>
                      <td style={{ padding: '40px 40px 32px' }}>
                        ...
                        <p style={{ margin: '0 0 32px', fontSize: '15px', color: '#5C6E62', lineHeight: '1.6' }}>
                          Hola <strong style={{ color: '#16130E' }}>{clientName}</strong>, hemos registrado tu reserva en{' '}
                          <strong style={{ color: '#16130E' }}>{businessName}</strong>.
                        </p>
