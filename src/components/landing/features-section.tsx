...
const features = [
  {
    number: "01",
    title: "Reservas 24/7",
    description: "Tus clientes reservan cuando quieran, desde cualquier dispositivo. Tu agenda se actualiza automáticamente sin que tengas que hacer nada.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Gestión de Equipo",
    description: "Asigna citas a diferentes profesionales, gestiona horarios y vacaciones. Todo sincronizado en tiempo real.",
    visual: "collab",
  },
  {
    number: "03",
    title: "Panel Unificado",
    description: "Todas tus reservas en un solo lugar. Confirma, cancela y consulta con un clic desde cualquier dispositivo. Sin papel, sin llamadas.",
    visual: "ai",
  },
];
...
function FeatureCard({ feature, index }: { feature: typeof features[0]; index: number }) {
  const [cardRef, isVisible] = useIntersectionObserver<HTMLDivElement>(0.2);
